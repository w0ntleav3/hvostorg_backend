...
class Employee(BaseModel):
    ...
    passport = db.Column(db.String(10), nullable=False)
    phone = db.Column(db.String(20), nullable=False)
    salary = db.Column(db.Integer, nullable=False)
    bank_acc_number = db.Column(db.String(20), nullable=False)
    contract_num = db.Column(db.BigInteger, nullable=False)

    post = db.relationship('Post', backref='owner', lazy=True)
